...
> **Status: 0.2.1, in the [Bazel Central Registry](https://registry.bazel.build/modules/rules_clj).**
...
> across Linux and macOS. `bazel_dep(name = "rules_clj", version = "0.2.1")` is all a
...
```starlark
# MODULE.bazel
bazel_dep(name = "rules_clj", version = "0.2.1")
```
